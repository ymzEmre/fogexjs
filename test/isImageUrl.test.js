const isImageUrl = require("../fogex/regex/isImageUrl");
...
it("should return true for image url format", () => {
  ...
  expect(isImageUrl("http://website.com/directory/image.jpg", "jpg")).toBe(
    true
  );
  expect(isImageUrl("http://website.com/directory/image.jpeg", "jpeg")).toBe(
    true
  );
  expect(isImageUrl("http://website.com/directory/image.png", "png")).toBe(
    true
  );
  expect(isImageUrl("http://website.com/directory/image.gif", "gif")).toBe(
    true
  );
  expect(isImageUrl("http://website.com/directory/image.txt", "txt")).toBe(
    false
  );
  expect(isImageUrl("http://website.com/directory/image.php", "php")).toBe(
    false
  );
